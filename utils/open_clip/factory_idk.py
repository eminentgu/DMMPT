...
def load_checkpoint(model, checkpoint_path, strict=False): ##change to false when test since i don;t want to load visual encoder when it isn't used
...
def create_model(
    ...
    '''if getattr(model.visual, 'image_size', None) is not None:
        print("factory line 317:",model.visual.image_size)
        # use image_size set on model creation (via config or force_image_size arg)
        force_preprocess_cfg['size'] = model.visual.image_size'''
    #####force_preprocess_cfg['size'] = (224,224) #edited
...
def create_model_and_transforms(
    ...
    preprocess_train, preprocess_val = 0,0
